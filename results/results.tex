...
\begin{figure}[h!]
	...
	\caption{Confusion Matric for predictions based on D/T.
	}
	\label{fig:confmatDT}
\end{figure}
...
Predictions were then made using the random forest algorithm. Using just the se\'rsic index exactly reproduced the results of the original decision tree with a success rate of 71\%, matching the binomial distribution again. 